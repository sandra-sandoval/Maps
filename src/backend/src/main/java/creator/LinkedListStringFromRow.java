...
/**
 * This class implements CreatorFromRow, where the generic T is a linked list of
 * Strings. This class
 * overrides the create method that allows the CSV parser to convert each row
