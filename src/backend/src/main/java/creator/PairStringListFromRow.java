...
/**
 * This class implements CreatorFromRow, where the generic T is a pair of String
 * and List of String.
 * This class overrides the create method that allows the CSV parser to convert
 * each row into an
...
public class PairStringListFromRow implements CreatorFromRow<Pair<String, List<String>>> {
   ...
   *
   * @param row a list of String, to be turned into a pair of String and List of
   *            String
   * @return the resulting pair of String and List of String representing the row
   * @throws FactoryFailureException if the row is empty and cannot be made into a
   *                                 pair
   */
  @Override
