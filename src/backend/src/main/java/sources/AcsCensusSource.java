...
/**
 * The AcsCensusSource class implements the CensusSource interface and overrides
 * its
 * getBroadbandAccess method. An object of this class is constructed with no
 * arguments, and when the
 * getBroadbandAccess method is called, an object of this class makes an API
 * call to the census API
 * to find the broadband access level of the given state and county, and returns
 * this level wrapped
 * in a CensusData object. If the broadband access level cannot be found for
 * some reason, this
...
public class AcsCensusSource implements CensusSource {
  ...
  /**
   * The constructor for the AcsCensusSource class, sets the stateIds field to an
   * empty HashMap.
   */
  ...
  /**
   * This method creates a http connection for the caller methods to connect to
   * the ACS API.
   *
  ...
  /**
   * This method returns the state code associated with the given String state.
   * The first time this
   * method is called while the server is running, this method stores all state
   * codes in the
  ...
  /**
   * This method returns the county code of the given county in the given state by
   * calling the
   * census API.
   *
   ...
   * @return a String representing the county code of the given county in the
   *         given state
  ...
  /**
   * This method finds the broadband access level of the given state and county
   * names. The
   * intermediate steps include finding the state's code and the county's code to
   * use in a final
   * query to the census API. This broadband access level is returned in a
   * CensusData object as the
   * data field. If the state / county combination is not found, throws a
   * DataSourceException.
   *
   * @param state  the String representing the state of the county for broadband
   *               level to be found
   * @param county the String representing the county for broadband level to be
   *               found
   * @return a CensusData object wrapping a Double representing broadband access
   *         level in the given
   *         state / county combination
   * @throws DataSourceException if the state / county combination is not found in
   *                             census data
   */
  @Override
