...
/**
 * This SearchCsvHandler class handles a /searchcsv request to our server. It is
 * constructed with a
 * CsvDataWrapper object, wrapping a List of List of String representing the CSV
 * data. If there is
 * data loaded in the CsvDataWrapper object, then this request searches that CSV
 * data with the given
...
public class SearchCsvHandler implements Route {
   ...
   *
   * @param csvData a CsvDataWrapper object wrapping a List of List of String of
   *                CSV data and a
  ...
  /**
   * Method that handles a /searchcsv request to our Server. Given a request and
   * response, returns a
   * failure or success response object. If successful, the response object
   * contains the rows of CSV
   ...
   * @return response object depending on whether the search was successful, and
   *         data found
   */
  @Override
  ...
  /**
   * A record representing a failed call to the /searchcsv handler, containing a
   * result with an
  ...
  /**
   * A record representing a successful call to the /searchcsv handler, containing
   * a result of
   * success, as well as the value, headers, and colid parameters, and the found
   * CSV data.
   *
   * @param result  the String containing "success"
   * @param value   the String containing the query parameter value to be matched
   *                in the CSV data
   * @param headers the String containing the query parameter headers, a boolean
   *                representing
   *                whether the CSV data to be searched has headers
   * @param colid   the String containing the numeric or non-numeric column
   *                identifier to search, or *
   *                to search every column
   * @param data    the List of List of String containing the matched CSV rows
   *                found
   */
