...
/**
 * This is a testing class that tests the EchoMockCensusSource class.
 * EchoMockCensusSource extends
 * the CensusSource class, and it is constructed with a CensusData object, and
 * overrides the
 * getBroadbandAccess method. This method takes a state name and a county name
 * as parameters, and
...
public class TestEchoMockCensusSource {
  /**
   * Given an empty string for state name and county name, and a CensusData object
   * containing the
   * Double 0, the mock source returns a CensusData object containing the Double
   * 0.
   */
  @Test
  ...
  /**
   * Given an empty string for county name and North Carolina for state name, and
   * a CensusData
   * object containing the Double 50, the mock source returns a CensusData object
   * containing the
   * Double 50.
   */
  @Test
  ...
  /**
   * Given Durham for county name and North Carolina for state name, and a
   * CensusData object
   * containing the Double 99.9999, the mock source returns a CensusData object
   * containing the
   * Double 99.9999.
   */
  @Test
  ...
  /**
   * Given Providence for county name and Rhode Island for state name, and a
   * CensusData object
   * containing the Double -0.01, the mock source returns a CensusData object
   ...
   * Given Durham for county name and North Carolina for state name, and a
   * CensusData object
   * containing the Double 0.00001, the mock source returns a CensusData object
   * containing the
   * Double 0.00001.
   */
  @Test
