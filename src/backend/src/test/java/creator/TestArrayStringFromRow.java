...
/**
 * This is a testing class that tests the ArrayStringFromRow class, which
 * implements CreatorFromRow.
 * An ArrayStringFromRow instance turns a list of string row into an array of
 * string row.
 *
