...
/**
 * This is a testing class that tests the LinkedListStringFromRow class, which
 * implements
 * CreatorFromRow. A LinkedListStringFromRow instance turns a list of string row
 * into a linked list
 * of string row.
 *
