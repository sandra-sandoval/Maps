...
/**
 * INTEGRATION TEST: sending real web requests to our server as it is running,
 * and seeing how the
 * pieces of the project, from the handlers to the sources, work together.
 *
 * <p>
 * This is a testing class that tests the SearchCsvHandler class.
 * SearchCsvHandler handles
 * /searchcsv requests to our Server. This class tests many cases for how this
 * /searchcsv can occur,
 * with different combinations of /loadcsv and /viewcsv calls preceding, and
 * different search
 * criteria.
 *
 * @version 1.0
...
public class TestSearchCsvHandler {
        ...
        /**
         * This method reinitializes the /loadcsv, /viewcsv, and /searchcsv endpoints,
         * and well as the
        ...
        /**
         * This method gracefully stops the endpoints after every test, and does not
         * proceed until the
         * server has stopped.
         */
        @AfterEach
        ...
        /**
         * Helper to start a connection to a specific API endpoint with query
         * parameters.
         *
        ...
        /**
         * This test verifies that if /searchcsv is called (with no parameters) before
         * any CSV file has
         * been loaded by a successful call to /loadcsv, the handler returns an error
         * response object.
         *
         * @throws IOException if the CSV searching done by the handler's call to
         *                     CsvSearcher fails
         */
        @Test
        public void testLoadedNoFileNoParameters() throws IOException {
                ...
                Map<String, Object> searchBody = adapter
        ...
        /**
         * This test verifies that if /searchcsv is called (with parameters) before any
         * CSV file has been
         * loaded by a successful call to /loadcsv, the handler returns an error
         * response object.
         *
         * @throws IOException if the CSV searching done by the handler's call to
         *                     CsvSearcher fails
        ...
        /**
         * This test verifies that if /loadcsv is called, but fails, and then /searchcsv
         * is called (with
         * parameters), that the search handler returns a failure response object with a
         * proper error code
         * and message.
         *
         * @throws IOException
        ...
        public void testLoadFailsBeforeSearch() throws IOException {
                String emptyFilepath = "/invalid.csv";
                HttpURLConnection loadConnection = tryRequest("loadcsv?filepath=" + emptyFilepath);
                assertEquals(200, loadConnection.getResponseCode());
                Map<String, Object> loadBody = adapter.fromJson(new Buffer().readFrom(loadConnection.getInputStream()));
        ...
        /**
         * This test verifies that if /loadcsv is called on a CSV file, and then
         * /searchcsv if called with
         * parameters that specify that there are no headers, but includes no search
         * parameters, that the
         * search handler returns a failure response object with a descriptive error
         * code and message.
         *
         * @throws IOException if the CSV searching done by the handler's call to
         *                     CsvSearcher fails
         ...
         * This test verifies that if /loadcsv is called on a CSV file, and then
         * /searchcsv if called with
         * parameters that specify that there are no headers, but includes no value
         * parameter, that the
         * search handler returns a failure response object with a descriptive error
         * code and message.
         *
         ...
         * This test verifies that if /loadcsv is called on a CSV file, and then
         * /searchcsv if called with
         * parameters that specify that there are no headers, but includes no headers
         * parameter, that the
         * search handler returns a failure response object with a descriptive error
         * code and message.
         *
         ...
         * This test verifies that if /loadcsv is called on a CSV file, and then
         * /searchcsv if called with
         * parameters that specify that there are no headers, but asks to search a
         * non-numeric column,
         * that the search handler returns a failure response object with a descriptive
         * error code and
         * message.
         *
         * @throws IOException if the CSV searching done by the handler's call to
        ...
        public void testLoadedFileHeadersFalseError() throws IOException {
                ...
                HttpURLConnection searchConnection = tryRequest(
                                "searchcsv?value=Bristol&headers=false&colid=City/Town");
                assertEquals(200, searchConnection.getResponseCode());
                Map<String, Object> searchBody = adapter
                                .fromJson(new Buffer().readFrom(searchConnection.getInputStream()));
                showDetailsIfError(searchBody);
         ...
         * This test verifies that if /loadcsv is called on a CSV file, and then
         * /searchcsv if called with
         * parameters that asks to search a non-numeric column header that does not
         * exist, that the search
         * handler returns a failure response object with a descriptive error code and
         * message.
         *
         * @throws IOException if the CSV searching done by the handler's call to
         *                     CsvSearcher fails
        ...
        public void testLoadedFileNonexistentHeader() throws IOException {
                ...
                HttpURLConnection searchConnection = tryRequest("searchcsv?value=Bristol&headers=true&colid=CityTown");
                assertEquals(200, searchConnection.getResponseCode());
                Map<String, Object> searchBody = adapter
                                .fromJson(new Buffer().readFrom(searchConnection.getInputStream()));
                showDetailsIfError(searchBody);
        ...
        /**
         * This test verifies that if /loadcsv is called on a CSV file, and it fails,
         * but then /loadcsv is
         * called again, and succeeds, and then /searchcsv is called, that /searchcsv is
         * successful and
        ...
        public void testLoadedFailLoadSucceedsSearch() throws IOException {
                String emptyFilepath = "data/census.csv";
                HttpURLConnection loadConnection = tryRequest("loadcsv?filepath=" + emptyFilepath);
                assertEquals(200, loadConnection.getResponseCode());
                Map<String, Object> loadBody = adapter.fromJson(new Buffer().readFrom(loadConnection.getInputStream()));
                assertEquals("error_datasource", loadBody.get("result"));
                ...
                assertEquals(200, loadConnection.getResponseCode());
                Map<String, Object> secondLoadBody = adapter
                                .fromJson(new Buffer().readFrom(secondLoadConnection.getInputStream()));
                assertEquals("success", secondLoadBody.get("result"));

                HttpURLConnection searchConnection = tryRequest("searchcsv?value=Bristol&headers=true&colid=City/Town");
                assertEquals(200, searchConnection.getResponseCode());
                Map<String, Object> searchBody = adapter
                                .fromJson(new Buffer().readFrom(searchConnection.getInputStream()));
                showDetailsIfError(searchBody);
                List<List<String>> expectedData = List
                                .of(List.of("Bristol", "\"80,727.00\"", "\"115,740.00\"", "\"42,658.00\""));
        ...
        /**
         * This test verifies that if one CSV file is loaded with /loadcsv, and then a
         * different file is
         * loaded with /loadcsv, that when /searchcsv is called, the second file loaded
         * is searched. Then,
         * a new file is loaded, and this test verifies that this third file is searched
         * when another call
         * to /searchcsv is made.
         *
         * @throws IOException if the CSV parsing done by the handler's call to
         *                     CsvParser fails
         */
        @Test
        public void testLoadFirstLoadSecondSearch() throws IOException {
                ...
                assertEquals(200, loadConnection.getResponseCode());
                Map<String, Object> loadSecondBody = adapter
                                .fromJson(new Buffer().readFrom(loadSecondConnection.getInputStream()));
                ...
                assertEquals(200, loadConnection.getResponseCode());
                Map<String, Object> loadThirdBody = adapter
                                .fromJson(new Buffer().readFrom(loadThirdConnection.getInputStream()));
                ...
                assertEquals(200, searchConnection.getResponseCode());
                Map<String, Object> secondSearchBody = adapter
                                .fromJson(new Buffer().readFrom(secondSearchConnection.getInputStream()));
                showDetailsIfError(searchBody);
         ...
         * This test verifies that if /loadcsv is called on a CSV file, and then
         * /searchcsv if called with
         * parameters that asks to search a non-numeric column header that is out of
         * range, that the
         * search handler returns a failure response object with a descriptive error
         * code and message.
         *
        ...
        public void testLoadedFileOutOfRangeId() throws IOException {
                ...
                HttpURLConnection searchConnection = tryRequest("searchcsv?value=Bristol&headers=true&colid=10");
                assertEquals(200, searchConnection.getResponseCode());
                Map<String, Object> searchBody = adapter
                                .fromJson(new Buffer().readFrom(searchConnection.getInputStream()));
                showDetailsIfError(searchBody);
        ...
        /**
         * This test verifies that if /loadcsv is called on an empty CSV file, and then
         * /searchcsv if
         * called with parameters, the handler returns a success response object with a
         * data field holding
         ...
         * This test verifies that if /loadcsv is called on a CSV file, and then
         * /searchcsv if called with
         * parameters that specify the wrong column to search for a target value, that
         * the handler returns
         * a success response object with a data field containing an empty list of found
         * rows.
         *
         * @throws IOException if the CSV searching done by the handler's call to
         *                     CsvSearcher fails
        ...
        public void testLoadedFileNothingFoundWrongIndex() throws IOException {
                ...
                HttpURLConnection searchConnection = tryRequest("searchcsv?value=Bristol&headers=false&colid=1");
                assertEquals(200, searchConnection.getResponseCode());
                Map<String, Object> searchBody = adapter
                                .fromJson(new Buffer().readFrom(searchConnection.getInputStream()));
                showDetailsIfError(searchBody);
         ...
         * This test verifies that if /loadcsv is called on an empty CSV file, and then
         * /viewcsv is
         * called, that all rows are returned in the success object by the view handler,
         * and that when
         * /searchcsv is called with parameter, the search handler returns a success
         * response object
         * containing only the rows of CSV data that fit the search criteria (with a
         * space in colid!!).
         *
         * @throws IOException if the CSV searching done by the handler's call to
         *                     CsvSearcher fails
        ...
        public void testLoadSearchFindRows() throws IOException {
                ...
                HttpURLConnection searchConnection = tryRequest(
                                "searchcsv?value=White&headers=true&colid=IPEDS%20Race");
                assertEquals(200, searchConnection.getResponseCode());
                Map<String, Object> searchBody = adapter
                                .fromJson(new Buffer().readFrom(searchConnection.getInputStream()));
                showDetailsIfError(searchBody);
        ...
        public void testLoadViewSearchFindRows() throws IOException {
                ...
                Map<String, Object> viewBody = adapter.fromJson(new Buffer().readFrom(viewConnection.getInputStream()));
        ...
        /**
         * This helper method prints the details of an error message if the response
         * body contains the
